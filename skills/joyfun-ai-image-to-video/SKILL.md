---
name: joyfun-ai-image-to-video
version: "1.0.0"
displayName: "Joyfun AI Image to Video — Convert Images Into Video Clips"
description: >
...
- "turning still images into short animated videos for social media creators"
...
# Joyfun AI Image to Video — Convert Images Into Video Clips
...
Here's a typical use: you send a a single product photo or illustrated scene, ask for animate this image into a 5-second video clip with smooth motion, and about 20-60 seconds later you've got a MP4 file ready to download. The whole thing runs at 1080p by default.

One thing worth knowing — high-contrast images with clear subjects animate more smoothly than busy backgrounds.

## Matching Input to Actions

User prompts referencing joyfun ai image to video, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `joyfun-ai-image-to-video` |
...
**Quick edit**: Upload → "animate this image into a 5-second video clip with smooth motion" → Download MP4. Takes 20-60 seconds for a 30-second clip.
